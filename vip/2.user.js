					...
					if (iqiyialiwaiobj) {} else if (pcliwaiobj || sjliwaiobj || jxjkobj || mmkjjtjobj || objj.match(/(?:douban|bilibili|acfun|douban|yinyuetai|kuwo|kugou|m1907|qq|xiami|migu|ximalaya|app-echo|1ting|lrts|baidu|wbdy)\./)) {
						...
						if (jxbpclwobj) {
							...
							if (obj.match(/^https?:\/\/zy\.aoxtv\.com\//)) {
								...
								titleobj('西瓜视频解析中');
							} else {} if (document.querySelector('body>div') != null) {} else {
								if (document.querySelector("body").innerText.match(/"\s*?url\s*?"\s*?:\s*?"\s*?http/img) != null) {
									window.location.href = "https://liuliuyy.com/player/play.html?url=" + document.body.innerText.replace(/^[\W\S]+?"\s*?url\s*?"\s*?:\s*?"([^"]+?)"[\W\S]*$/i, "$1").replace(/\\\//g, "/");
								} else {}
							}
						} else {
							jxbmmanzxobj();
					...
					function jxbmmanzxobj() {
						...
						(function() {
							...
							let aa = 1, bb = '<span><a1 style="display:none"></a1><a2 style="display:none">', cc = '<span><a1 style="color:darkgreen">搜索</a1><a2 style="display:none">', dd = '<span><a1 style="color:darkgreen">跳转</a1><a2 style="display:none">', ee = '<span><a1 style="color:darkgreen">小窗</a1><a2 style="display:none">', eee = '<span style="background-color:cyan"><a1 style="color:darkgreen">Json</a1><a2 style="display:none">', ff = '<span><a1 style="color:darkgreen">大窗</a1><a2 style="display:none">', ii = '<span style="background-color:hotpink"><a1 style="color:darkgreen"></a1><a2 style="display:none">', kk = '<span style="display:grid;background-color:aliceblue"><a1>自用</a1><a2 style="display:none">', jj = '<span style="background-color:darkorange"><a1 style="color:darkgreen"></a1><a2 style="display:none">', gg = '</a2><a3 style="color:#2196F3;zoom:0.8;font-weight:bold;">➽</a3><a4>', hh = '</a2><a3 style="display:none"></a3><a4>', https = [{
								...
								name: ii + aa+++hh + "求生",
								url: "https://www.dggzcw.com/jiexi/analysis.php?v="
							}, {
								name: ii + aa+++hh + "极速",
								url: "https://url.js.cn/?url="
							}, {
								name: ii + aa+++hh + "纯白",
								url: "https://bfqqd.lekkan.com/m3u8.php?url="
							}, {
								name: ii + aa+++hh + "捂捂",
								...
								name: bb + aa+++hh + "玻璃",
								url: "https://vip.bljiex.com/jb/?url="
							}, {
								name: bb + aa+++hh + "乐多",
								...
								name: bb + aa+++hh + "无极",
								url: "https://jx.wujiys.com/wjj/?url="
							}, {
								name: bb + aa+++hh + "淘影",
								...
								name: bb + aa+++hh + "百叶",
								url: "https://titan.mgtv.com.baiyeys.com/?url="
							}, {
								name: bb + aa+++hh + "麒麟",
								url: "https://jx.sujx.top/vip/?url="
							}, {
								name: bb + aa+++hh + "意识",
								url: "https://api.147g.cc/m3u8.php?url="
							}, {
								name: bb + aa+++hh + "奇米",
								url: "https://qimihe.com/?url="
							}, {
								name: bb + aa+++hh + "丽江",
								url: "https://jc.6699hj.com/?url="
							}, {
								name: bb + aa+++hh + "沙漠",
								url: "https://www.ssamao.com/jx/?url="
							}, {
								name: bb + aa+++hh + "看剧",
								url: "https://jx.kanjumao.cn/?url="
							}, {
								name: bb + aa+++hh + "无名",
							...
							if (jxbpcobj) {
								...
								(function() {
									try {
										...
										let sjtzsjzdylwobj = /(?:片库|久已|蓝影|放开|冰豆|师兄|麻瓜)/, sjqjpbzdylwobj = /(?:云栖|云波|时光|锦云|说说|回响|夜空|星影|1717|8090|唯多|无名|墨鱼|哔哩|淘影|诺讯|大亨|小蒋|玩嗨|九八|恐龙|极速|刺客|七彩|音萌|恶灵)/i, sjyyyzdypbobj = /(?:看剧|玻璃|爱跟|海绵|可乐|一零|六六|我爱|神马|解啦|盘古|酷看|七彩|久播|和巴|恶灵|吉塔|乐多|枫林|大师|盖斯|CKP|和巴|思[古云念]|蘑菇|OK|狼云|迪奥|618G?|云端|147|256|365|920|973|4080|星驰|黑云|九八|金桥)/i;
									...
									if (pcliwaiobj && !objj.match('ixigua\.')) {
										(function() {
											try {
												...
												localStorage.setItem("httpsjk", createRandom2(1, document.querySelectorAll("ul#httpsvipul>li").length - 19, document.querySelectorAll("ul#httpsvipul>li").length - 1));
												setTimeout(function() {
													try {
														$("ul#httpsvipul>li>span").css("backgroundImage", "");
														document.querySelector("ul#httpsvipul>li:nth-child(" + localStorage.getItem("httpsjk") + ")>span").style.backgroundImage = "url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAkAAAAMCAMAAACHgmeRAAAABGdBTUEAALGPC/xhBQAAAAFzUkdCAK7OHOkAAAAbUExURX//AIH8BobyGoT/CZP/J4nxIIL5C5T8LJj0PW2hJpgAAAAeSURBVAjXY2BlY4QABiZGBiigNouVGQoYONhZIAAAEpYAdsB2b4AAAAAASUVORK5CYII=)";
									...
									if (pcliwaiobj && !objj.match('ixigua\.')) {
										(function() {
											try {
												...
												localStorage.setItem("httpsjk", createRandom2(1, 4, document.querySelectorAll("ul#httpsvipul>li").length - 19));
												setTimeout(function() {
													try {
														$("ul#httpsvipul>li>span").css("backgroundImage", "");
														document.querySelector("ul#httpsvipul>li:nth-child(" + localStorage.getItem("httpsjk") + ")>span").style.backgroundImage = "url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAkAAAAMCAMAAACHgmeRAAAABGdBTUEAALGPC/xhBQAAAAFzUkdCAK7OHOkAAAAbUExURX//AIH8BobyGoT/CZP/J4nxIIL5C5T8LJj0PW2hJpgAAAAeSURBVAjXY2BlY4QABiZGBiigNouVGQoYONhZIAAAEpYAdsB2b4AAAAAASUVORK5CYII=)";
